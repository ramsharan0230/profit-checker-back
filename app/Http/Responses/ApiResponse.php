...
class ApiResponse {
    ...
    {
        return response()->json(['payload'=>$data, 'message'=>$message, 'status_code'=>$statusCode], Response::HTTP_OK);
    }

    public static function error($message="", $statusCode=Response::HTTP_INTERNAL_SERVER_ERROR): JsonResponse
    {
        return response()->json(['message'=>$message, 'status_code'=>$statusCode], Response::HTTP_OK);
    }
}